 ...
 */
class ElasticsearchObject extends FieldPluginBase implements MultiItemsFieldHandlerInterface {
   ...
   * Setting filter.
   *
   * @param \Drupal\views\Plugin\views\field\FieldPluginBase $realFilter
   *   Real filter that processes this filter.
   *
   * @return \Drupal\elasticsearch_connector\Plugin\views\sort\ElasticsearchObject
   *   Self.
   */
  public function setRealFilter(FieldPluginBase $realFilter): self {
   ...
   */
  public function createRealFilter(string $plugin_id): FieldPluginBase {
   ...
   *   Filter instance.
   */
  public function getRealFilter(): ?FieldPluginBase {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    if ($this->realFilter instanceof FieldPluginBase) {
  ...
  public function query() {
    if ($this->realFilter instanceof FieldPluginBase && !empty($this->options['property_select']['property'])) {
  ...
  public function render_item($count, $item) {
    if ($this->realFilter instanceof FieldPluginBase) {
      return $this->realFilter->render_item($count, $item);
    }
    return '';
  }
